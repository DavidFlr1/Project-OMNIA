...
export class Bot {
  ...
  setInteractionResponses(responses: string[]): void {
    if (this.interactionManager) {
      this.interactionManager.setResponses(responses)
    }
  }

  addInteractionResponse(response: string): void {
    if (this.interactionManager) {
      this.interactionManager.addResponse(response)
    }
  }
}
